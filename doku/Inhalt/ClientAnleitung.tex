...
Wurde ein Start- oder Zielpunkt gewählt (siehe \nameref{ssec:StartZielpunkt}), wird der nächste gewählte Punkt automatisch zum Ziel-, bzw. Startpunkt, und eine Route eingezeichnet. Start und Ziel bekommen jeweils ein ansprechendes Symbol und unten im Bild ist eine Einblendung über Start und Ziel.
\begin{figure}[H]
\centering
...
\caption{Point of Interest Dialog}
\label{fig:PoIDialog}
\end{figure}
