...
\section{QR-Tags}
\label{QR-Tags}
An den Räumen werden QR-Tags angebracht, die eine Zuordnung 
zu einem Knoten auf der ermöglicht. Hier ist zu beachten,
dass die Informationen auf dem QR-Tag auch für andere Anwendungen
nützlich sein sollen. Deshalb kann hier nicht nur eine Knoten-ID
hinterlegt werden.
...
\section{NFC-Tags}
\label{NFC-Tags}
Neben den QR-Tags werden auch NFC-Tags an den Räumen angebracht.
Auf diese werden aktuell keine Informationen geschrieben. Die
Knoten werden über die NFC-ID des Chips zugeordnet.
