...
Im folgenden Abschnitt wird zunächst die allgemeine Struktur erläutert und anschließend liegt das Hauptaugenwerk auf der Benutzeroberfläche. Eine ausführliche Bedienungsanleitung der Administrationsumgebung ist im Anhang \ref{Admin-Doku} beigefügt.
...
Eine Möglichkeit der Positionierung innerhalb des StudMap-Projektes ist das 
...
in einer Tabelle angezeigt. Anschließend kann in dieser Tabelle noch nach 
