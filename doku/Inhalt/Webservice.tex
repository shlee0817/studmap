...
% Wird der Graph nicht auf der ganzen Map abgebildet? Wieso also FloorId?
Eigenschaften:\\
\begin{tabularx}{\textwidth}{|l|X|}
...
%% Nicht als Klasse im Core-Verzeichnis vorhanden.
...
\todo{Alle genauen Fehlertypen beschreiben.}
\textbf{Allgemein:}
\begin{itemize}
...
\todo{GetFloorsForMap, GetFloor, GetFloorplanImage, UploadFloorImage}

\subsection{SaveGraphForFloor}
\label{service:SaveGraphForFloor}
\todo{Im Code mit Übergabeparameter}
...
\todo{GetNodeInformation, GetFullNodeInformationForNode}

\subsection{SaveNodeInformation}
\todo{Im Code mit Parametern}
